...
void setup() {
  ...
  //check if MLX90614 sensor connected
/*   if (!mlx.begin()) {
    M5.Lcd.println("Error connecting to MLX90614");
    while (1); // Stop if no sensor is found
  } */
...
void Cura_SettingBtnC(){
    ...
    Button HelpButton(5, 4, 311, 230, false, "Alert Help", off_clrs, on_clrs, MC_DATUM );
    // (x, y, width, height, isToggle, label, off_colors, on_colors, datum)
